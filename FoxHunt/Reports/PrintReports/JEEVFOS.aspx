<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="JEEVFOS.aspx.cs" Inherits="FoxHunt.Workers.JEEVFOS" %>
...
FROM [BOEInventory]. [DeliveryDropOff] do
  ...
  where ElectionID = @eid and OneStopID = @osid", Data.currentElection.id, onestopid);
...
FROM [BOEInventory]. [DeliveryDropOff] do
  ...
  where ElectionID = @eid and OneStopID = @osid", Data.currentElection.id, onestopid);
    ...
    <div class="sig">Site Coordinator 1:<br />       
    <%=Data.getSigImg(row,"sigJudge1")%></div>
    <div class="sig">Site Coordinator 2:<br />        
