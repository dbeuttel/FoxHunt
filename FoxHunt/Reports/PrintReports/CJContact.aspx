   ...
   <%-- <asp:Label ID="Label1" runat="server" Text="Label"></asp:Label>--%>
    ...
    <hr style="margin-bottom:0px;"/>
        ...
        <h1 style= "text-align:center; color:black; background-color:lightgray; margin:0px; padding:15px; margin-left:-15px; margin-right:-15px;"> 
            <b>Chief Judge Contact Sheet &nbsp <%= Data.currentElection.election_dt %></b> </h1>
        
            
    
            <hr />
    
            <h6 style= "text-align: center; font-size:medium;">  THIS CHIEF JUDGE CONTACT SHEET IS TO BE USED TO COMMUNICATE WITH OTHER WORKERS  
                THE TIME OF THE PRE-ELECTION MEETING ALONG WITH OTHER IMPORTANT DETAILS AS INSTRUCTED BY THE BOARD OF ELECTIONS. </h6>
...
<br>
    <div class="row">
        <h4 class="col-3 sechead">BOE Contact Information</h4>
    </div>
   <%foreach (System.Data.DataRow row in boecontacts.Rows)
            {%>
 ...
 padding:25px; padding-left:50px; padding-right:50px;     margin-left: -15px;
    margin-right: -15px;"><!--Start POLLING PLACE INFORMATION -->
        ...
        <div class="row" >
            ...
            <div class="col-3 form-control hfix"><%= row["city"] %>,&nbsp<%= row["state"] %>&nbsp<%= row["zip"] %></div>
            

         </div>
        <div class="row" >
              <div class="col-md-3" style="font-size:large; ">Voting Enclosure: </div>
            <div class="col-3 form-control hfix"><%=row["votingenclosure"]%></div>
