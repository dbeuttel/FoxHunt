...
{
    public partial class JEEVFOS : FoxHunt.Workers.PrintReports.BasePrintReport
    {
...
",  precinctid);
            ...
            contactTable = Data.getSiteManagement(Data.currentElection.id,onestopid, precinctid);
