<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="DashBoard.aspx.cs" Inherits="FoxHunt.Workers.DashBoard" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	<%@ Register Assembly="reporting" Namespace="Reporting" TagPrefix="reports" %>
	<%--<reports:Report runat="server" ReportName="Dashboard" ID="repDashboard"></reports:Report>--%>
